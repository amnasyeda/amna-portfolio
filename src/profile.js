...
const about = {
  paragraph:
    "I am a junior web-developer and I am currectly working on small projects as a freelanced developer. Prior to changing my career path to software and web development, I obtained my Honors Bachelor of Science degree from the University of Toronto and completed a double major in human biology and neuroscience. I am still an active researcher for mental health and neuroscience.",
};
